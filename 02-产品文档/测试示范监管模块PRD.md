...
- 申请列表和申请详情车辆信息提供同一登记入口；登记时录入临时牌照号、有效期（起止日期）并上传牌照照片（必填，支持 JPG/PNG 格式），不新增待办、通知、独立页面或二次审核。
- 用户须一次完成全部待登记车辆的牌照号、有效期和牌照照片；系统校验必填、牌照号格式、同一申请内重复及有效期起早于有效期止，校验通过后申请自动生效。已生效申请仅只读展示牌照信息。
