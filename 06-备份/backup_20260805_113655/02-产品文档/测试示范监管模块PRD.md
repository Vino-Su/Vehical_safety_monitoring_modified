...
- 筛选：报告名称、报告周期
- 列表：报告名称、报告周期、发布机构、发布时间、操作（查看详情/下载）
- 报告周期枚举值：月度、季度、年度（与 F18 报告周期字段一致）
- 详情弹窗：展示报告基本信息（报告名称、报告周期、发布机构、发布时间）、报告正文与附件，不展示关键数据概览及各类统计图表（里程统计、载客统计、车辆类型分布、企业排名等）
