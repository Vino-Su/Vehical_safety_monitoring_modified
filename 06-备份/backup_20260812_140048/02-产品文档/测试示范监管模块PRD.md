...
> V3.8（2026-08-12）：F04/F05/F06/F08 道路测试、示范应用、商业化试点准入申请及审批详情中的人员表统一展示姓名、性别、年龄、证件号码、人员类型、操作；新建申请中可查看或移除已选人员，详情和审批详情中可查看人员信息。F06 商业化试点初次申请与道路测试、示范应用表单统一信息层级：时间段明确提示商业化试点时长原则上不超过6个月且不得超过保险凭证有效期，并按所选车辆中最早保险有效期校验；车辆选择弹窗补齐示范应用里程及小时、交通违法次数、交通事故次数、保险有效期，已选车辆区明确临时行驶车号牌在审批通过后另行上传；人员选择与空状态统一使用“商业化试点驾驶人（安全员）”业务名称。
...
5. **测试人员表格**：姓名、性别、年龄、证件号码、人员类型、操作；新建申请操作为查看、删除，详情操作为查看人员信息
...
5. **人员表格**（标题为人员信息）：姓名、性别、年龄、证件号码、人员类型、操作；申请详情与审批详情的操作仅支持查看人员信息
