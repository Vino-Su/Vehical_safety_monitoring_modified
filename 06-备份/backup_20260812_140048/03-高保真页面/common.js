(function () {
  ...
  function injectStyles() {
    var cssText = [
      ...
      '[data-fixed-cols].has-overflow .fcol-start-last{box-shadow:8px 0 12px -8px rgba(0,0,0,.18)}',
      '[data-fixed-cols].has-overflow .fcol-end{box-shadow:-8px 0 12px -8px rgba(0,0,0,.18)}'
    ].join('');
