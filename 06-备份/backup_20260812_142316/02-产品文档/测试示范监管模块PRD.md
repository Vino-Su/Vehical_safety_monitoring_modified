...
5. **测试人员表格**：姓名、性别、年龄、证件号码、人员类型、操作；新建申请操作为查看、删除，详情操作为查看（点击后展示人员信息）
...
5. **人员表格**（标题为人员信息）：姓名、性别、年龄、证件号码、人员类型、操作；申请详情与审批详情的操作仅显示查看，点击后查看人员信息
