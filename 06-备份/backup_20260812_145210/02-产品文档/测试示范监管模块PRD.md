...
> V3.7（2026-08-11）：F22 交通违法信息的导出入口与查询、重置统一归入查询操作区，导出范围仍遵循当前筛选条件；F11 在线反馈管理的导出入口与查询、重置统一归入查询操作区，导出范围仍遵循当前筛选条件或已选记录；F04/F05/F06/F08 道路测试、示范应用、商业化试点准入申请及审批统一按规程附件分组展示：道路测试为附件1-3申请文件、附件4申请材料和自动驾驶道路测试补充材料，示范应用为附件1/6/7申请文件、附件8申请材料和自动驾驶示范应用补充材料，商业化试点为附件1/9/10申请文件、附件11申请材料和商业化试点安全保障方案；附件4回归规程原有16项顺序、附件8回归规程原有13项顺序、附件11回归规程原有12项顺序，营业执照自动关联、安全员材料关联已选人员档案，材料全称按规程原文提供查看；道路测试、示范应用、商业化试点的延期、变更和新增相同配置车辆三类派生申请均须上传最新安全性自我声明，并与初次申请采用一致的附件上传、替换、预览和下载交互；审批仅保留整体通过/退回和附件查看，不新增材料状态、核验状态或单项审核；道路测试新建申请支持取消，取消后不保存已填写内容并关闭弹窗；F04/F05/F06/F08 的申请详情与审批详情统一使用相同的附件分组信息结构，逐项展示材料编号、材料名称、文件或关联档案及可执行操作；F07 提交报告弹窗新增报告标题字段，用户必须填写后方可提交，申请选择列表展示申请类型、申请编号、阶段性与总结性报告数量及申请有效期起止；F09 报告查询与材料归档的申请选择列表统一展示申请类型、申请编号、阶段性与总结性报告数量及申请有效期起止，材料归档额外展示归档状态。

> V3.8（2026-08-12）：F04/F05/F06/F08 道路测试、示范应用、商业化试点准入申请及审批详情中的人员表统一展示姓名、性别、年龄、证件号码、人员类型、操作；新建申请中可查看或移除已选人员，详情和审批详情中操作文案为“查看”，点击后打开人员完整档案，包含基本信息、驾驶资质、人员类型、交通违法与事故记录、培训与资质信息；安全员或远程操控员另展示专项培训及远程操控信息。F06 商业化试点初次申请与道路测试、示范应用表单统一信息层级：时间段明确提示商业化试点时长原则上不超过6个月且不得超过保险凭证有效期，并按所选车辆中最早保险有效期校验；车辆选择弹窗补齐示范应用里程及小时、交通违法次数、交通事故次数、保险有效期，已选车辆区明确临时行驶车号牌在审批通过后另行上传；人员选择与空状态统一使用“商业化试点驾驶人（安全员）”业务名称。
...
- 需提交材料：原安全性自我声明、最新安全性自我声明、变更理由及必要性说明、相应证明材料；最新安全性自我声明须由申请主体上传；若 " 车辆配置及道路测试项目是否发生变更 " 为是，还需提交变更测试检验报告
- 已变更字段在详情页中高亮标注
...
5. **测试人员表格**：姓名、性别、年龄、证件号码、人员类型、操作；新建申请操作为查看、删除，详情操作为查看（点击后打开人员完整档案，展示基本信息、驾驶资质、人员类型、交通违法与事故记录、培训与资质信息；安全员或远程操控员额外展示专项培训及远程操控信息）
...
| 示范应用车辆   | 表格多选 | 是    | 至少 1 辆    | —    | 数据来源：车辆登记，展示 VIN 码、道路测试里程及小时；初次申请不录入临时牌照，审批通过后再办理号牌申领                                                                       |
...
- 变更材料要求：原安全性自我声明和原申请附件保持只读关联；本次上传最新安全性自我声明、变更理由及必要性说明、相应证明材料
- 提交流程：提交变更申请 → 第三方初审 → 市工作专班审核确认 → 上传临时牌照
...
左侧主内容区与道路测试结构一致。附件区按“附件1/6/7：申请文件”“附件8：申请材料”“自动驾驶示范应用补充材料（仅自动驾驶示范应用）”展示；延期、变更和新增相同配置车辆申请同时展示本次新增附件、最新安全性自我声明及原申请关联附件。每项简称均可查看对应规程完整原文，文件或关联档案均支持预览和下载。右侧版本演进卡片改为按钮形式（点击 " 申请活动版本演进 " 按钮打开弹窗）。车辆展示字段调整为：VIN 码、道路测试里程及小时、交通违法次数、交通事故次数、保险有效期、临时牌照、临时牌照有效期。
...
**表单提示与车辆展示统一规则：** 商业化试点时间段下方显示“自我声明载明的商业化试点时长原则上不超过6个月，且不得超过保险凭证有效期。”；开始日期不得早于当前日期，提交时以所选车辆中最早的保险有效期和6个月上限共同校验。商业化试点车辆区在“添加车辆”后说明临时行驶车号牌在审批通过后另行上传；车辆选择弹窗展示示范应用里程及小时、交通违法次数、交通事故次数、保险有效期，已选车辆表格展示 VIN 码、品牌、型号、级别、示范应用里程及小时，与道路测试、示范应用新建申请保持同一信息层级。
...
- 延期：商业化试点模式、商业化试点类型、申请主体、路段、车辆、人员只读；仅商业化试点时间段可修改；延期时长一次不超过 6 个月；原申请附件保持只读关联，本次上传最新商业化试点安全性自我声明、智能网联车辆示范应用申请书、前期商业化试点评估报告、延期必要性说明等申请材料；提交流程：提交延期申请 → 第三方初审 → 市工作专班审核确认 → 上传临时牌照
- 变更：商业化试点模式、商业化试点类型、申请主体只读；其余字段可编辑；原安全性自我声明和原申请附件保持只读关联，本次上传最新商业化试点安全性自我声明、变更原因及必要性说明、相应证明材料；无 " 车辆配置及项目是否发生变更 " 字段，无需提交变更测试检验报告；商业化试点时间段校验不得早于现有日期；提交流程：提交变更申请 → 第三方初审 → 市工作专班审核确认 → 上传临时牌照
...
2. 审批人查看申请信息、附件及关联档案后，在审批操作区填写审批意见并执行整体“通过”或“退回”；不新增单项材料审核、材料状态或核验状态
3. 点击 " 通过 "：
...
- 变更申请关联原申请附件和原安全性自我声明，仅上传最新安全性自我声明、变更理由及必要性说明及相应证明材料。
- 新增相同配置车辆申请关联原申请附件，仅上传最新安全性自我声明、增加车辆数量及必要性说明及适用于新增车辆的补充材料。
...
- [ ] 道路测试延期、变更和新增相同配置车辆申请均要求上传最新安全性自我声明，并在申请详情、审批详情中可查看
...
- [ ] 示范应用延期、变更和新增相同配置车辆申请均上传最新安全性自我声明，并关联原申请附件；本次新增附件与关联附件均可查看
- [ ] 商业化试点延期、变更和新增相同配置车辆申请均上传最新商业化试点安全性自我声明；延期另上传第四十二条申请书、前期商业化试点评估报告、延期必要性说明，变更关联原声明并上传最新声明、原因和证明，新增车辆关联原申请材料并按统一附件式展示
- [ ] 车辆展示字段包含里程/违法/事故/保险
...
- [ ] 审批操作仅包含整体通过、整体退回及审批意见，不展示材料状态、核验状态或单项审核操作
- [ ] 审批通过：正确流转到下一节点
